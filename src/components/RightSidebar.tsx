        ...
        {!hasStartedChat ? (
          <>
            <div className="mb-8">
              ...
              <h2 className="text-3xl font-extrabold whitespace-nowrap overflow-hidden text-ellipsis bg-gradient-to-r from-purple-600 via-purple-400 to-purple-700 text-transparent bg-clip-text">
                For a New Age
              </h2>
            </div>
