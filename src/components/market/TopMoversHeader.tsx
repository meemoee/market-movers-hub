...
export function TopMoversHeader({
  ...
  return (
    <div className="sticky top-14 z-40 w-full">
      {/* Add 'container' so it has the same centering & width constraints as the header */}
      <Card className="container rounded-t-none border-t-0 bg-card/95 
                      backdrop-blur-supports-backdrop-blur:bg-card/95 
                      backdrop-blur-supports-backdrop-blur:backdrop-blur-sm
                      p-4 w-full relative">
