...
interface TopMoversHeaderProps {
  ...
  onSortChange: (value: 'price_change' | 'volume' | 'price_volume_impact') => void;
}
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end" className="w-[300px] bg-background/95 backdrop-blur-sm border-border">
              ...
              <div className="p-2 space-y-1">
                ...
                <Select
                  value={sortBy}
                  onValueChange={(value: 'price_change' | 'volume' | 'price_volume_impact') => onSortChange(value)}
                >
                  <SelectTrigger>
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="price_volume_impact">Volume × Price Impact</SelectItem>
                  </SelectContent>
                </Select>
              </div>
              <DropdownMenuSeparator />
