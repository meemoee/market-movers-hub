...
import { Loader2, History, CheckCircle, AlertCircle, Clock } from "lucide-react";
import { ResearchJob } from "@/types/research";

interface ResearchHistoryProps {
  savedJobs: ResearchJob[];
  isLoading: boolean;
  onSelectJob: (jobId: string) => void;
  extractProbability: (job: ResearchJob) => string | null;
}

export function ResearchHistory({ savedJobs, isLoading, onSelectJob, extractProbability }: ResearchHistoryProps) {
