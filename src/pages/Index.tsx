      ...
      <div className="flex relative max-w-[1280px] mx-auto gap-6">
        ...
        <aside 
          className={`
            ...
            transition-transform duration-300 ease-in-out bg-background overflow-hidden
          `}
        >
          <div className="flex flex-col h-full">
            {/* Fixed logo header */}
            <div className="flex-shrink-0 ml-2 px-4 py-3 bg-background sticky top-0 z-20 border-b border-border/10">
