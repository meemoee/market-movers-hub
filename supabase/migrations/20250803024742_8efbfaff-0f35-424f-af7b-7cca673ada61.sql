...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_market_prices_market_timestamp 
ON market_prices (market_id, timestamp DESC);

CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_market_prices_market_price_filter 
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_market_prices_timestamp_desc 
